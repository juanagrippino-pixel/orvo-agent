...
- [`docs/architecture-reviews/2026-06-04-arb-cron-update.md`](architecture-reviews/2026-06-04-arb-cron-update.md) — latest ARB branch disposition, shipped baseline checkpoint, and next merge-train recommendations.
