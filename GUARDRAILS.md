...
| GET | `/internal/brain/businesses/<business_id>/cases/top` | `internal_brain_cases_top` | `actionable_total`/`actionable_degraded_total`, `business_id`, `cases`, `count`, `limit`, `now`, `projection_type`, `ranking` |
