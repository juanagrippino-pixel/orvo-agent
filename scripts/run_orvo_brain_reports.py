...
SUPPORTED_DAILY_CONNECTORS = {"csv", "google_sheets", "mercadolibre", "meta_ads", "tiendanube"}


def _enabled_daily_connector_types(business) -> list[str]:
    connector_types: list[str] = []
    for connector in business.connectors:
        if not connector.enabled or connector.connector_type not in SUPPORTED_DAILY_CONNECTORS:
            continue
