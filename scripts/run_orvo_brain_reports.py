...
SUPPORTED_FORCED_CONNECTORS = {"google_sheets", "tiendanube", "mercadolibre", "meta_ads", "csv"}
...
def _enabled_supported_connector_types(business) -> list[str]:
    connector_types = [
        ...
        if connector.enabled and connector.connector_type in SUPPORTED_FORCED_CONNECTORS
    ]
