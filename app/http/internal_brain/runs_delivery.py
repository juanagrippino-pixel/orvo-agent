...
def _append_delivery_status_audit_event(
    *,
    business_id: str,
    actor_ref: str,
    event_type: str,
...
def _delivery_status_success(
    business_id: str,
    *,
    event_business_id: str | None = None,
    ...
    try:
        ...
        if actor_ref is not None and audit_scope is not None:
            _append_delivery_status_audit_event(
                business_id=business_id,
                actor_ref=actor_ref,
    ...
    if actor_ref is not None and audit_scope is not None:
        audit_data = {"status": "allowed", "limit": limit}
...
def register_run_delivery_routes(app):
    ...
    def internal_brain_whatsapp_delivery_statuses():
        ...
        return _delivery_status_success(
            business_id,
