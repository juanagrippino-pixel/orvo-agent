...
_WORK_ITEM_QUERY_FIELD_DEFINITIONS: tuple[WorkItemQueryFieldDefinition, ...] = (
    ...
    WorkItemQueryFieldDefinition("freshness_state", "enum", frozenset(get_args(EvidenceFreshnessState))),
    WorkItemQueryFieldDefinition("degraded", "bool", allowed_operators=frozenset({"=", "!="})),
    WorkItemQueryFieldDefinition("assigned", "bool", allowed_operators=frozenset({"=", "!="})),
