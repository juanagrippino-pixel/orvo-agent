...
DEFAULT_METRIC_DEFINITIONS: tuple[MetricDefinition, ...] = (
    _definition(
        ...
        label="Orders",
        unit="count",
        allowed_sources=("csv", "google_sheets", "mercadolibre", "sample", "tiendanube", "woocommerce"),
    ...
    _definition(
        ...
        unit="count",
        allowed_sources=("csv", "google_sheets", "sample", "tiendanube", "woocommerce"),
    ...
    _definition(
        ...
        unit="count",
        allowed_sources=("csv", "google_sheets", "sample", "whatsapp"),
    ...
    _definition(
        ...
        unit="timestamp",
        allowed_sources=("csv", "google_sheets", "mercadolibre", "meta_ads", "sample", "tiendanube", "woocommerce"),
        aggregation="latest",
        case_allowed=True,
    ...
    _definition(
        ...
        label="Ad spend",
        unit="money",
        allowed_sources=("csv", "google_sheets", "meta_ads", "sample"),
