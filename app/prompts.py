...
- Demo para ecommerce D2C: https://orvo.space/demo-artemea.html
...
- Tecnología de punta (IA generativa, LangGraph y conectores comerciales)
- Enfoque comercial: no solo responde, también ayuda a vender y calificar

## Agendar una demo

Para ver el agente en acción o hablar del proyecto:
https://orvo.space/#contacto

WhatsApp directo: +5491100000000
""".strip()
...
- "commerce" → el usuario menciona EXPLÍCITAMENTE ecommerce, Tiendanube, Shopify, WooCommerce, D2C, pedidos, stock, carritos o reportes operativos
...
- "human" → el usuario pide EXPLÍCITAMENTE hablar con una persona real, humano, soporte humano o está frustrado y quiere escalar
...
- Solo usá "commerce" cuando el usuario mencione operaciones ecommerce explícitamente
...
- Si muestra interés concreto, ofrecé demo corta o llamada.
""".strip()
...
→ "Te puedo mandar algo, pero una demo en vivo de 15 minutos te dice más que cualquier PDF. ¿Tenés tiempo esta semana? → https://orvo.space/#contacto"
...
Convencer al dueño u operador de una tienda online de que Orvo le resuelve problemas reales:
- Su equipo no puede responder a toda hora
- Pierde ventas cuando está cerrado o el vendedor está ocupado
- Necesita métricas confiables, seguimiento de pedidos, stock, campañas y casos accionables

Mostrá la demo: https://orvo.space/demo-artemea.html
Si muestra interés real, invitalo a agendar: https://orvo.space/#contacto
""".strip()
...
4. Si el usuario muestra interés real, ofrecé demo o llamada: https://orvo.space/#contacto
...
2. Si el usuario insiste en hablar con una persona, le das el contacto comercial
...
Agendá directo: https://orvo.space/#contacto
O WhatsApp: +5491100000000
